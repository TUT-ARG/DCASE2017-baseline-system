...
def main(argv):
    ...
    for parameter_set in parameters_sets:
        ...
        app = Task1AppCore(name='DCASE 2017::Acoustic Scene Classification / Baseline System',
                           params=params,
        ...
        # System evaluation in challenge mode
            ...
            challenge_app = Task1AppCore(name='DCASE 2017::Acoustic Scene Classification / Baseline System',
                                         params=params,
                                         system_desc=params.get('description'),
                                         system_parameter_set_id=params.get('active_set'),
