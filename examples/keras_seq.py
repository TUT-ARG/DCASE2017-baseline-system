...
from dcase_framework.features import FeatureContainer, FeatureRepository, FeatureExtractor, FeatureNormalizer, FeatureStacker, FeatureAggregator, FeatureMasker
from dcase_framework.metadata import EventRoll, MetaDataContainer, MetaDataItem
...
class LargeScaleAppCore(BinarySoundEventAppCore):
    pass
...
def main(argv):
    ...
    parser = argparse.ArgumentParser(
        ...
        description=textwrap.dedent('''\
            ...
            Example how to use keras_seq learner
            ---------------------------------------------
    ...
    for parameter_set in parameters_sets:
        ...
        app = LargeScaleAppCore(name='DCASE 2017::Detection of rare sound events / Baseline System',
                                params=params,
        ...
        # System evaluation with challenge data
            ...
            challenge_app = LargeScaleAppCore(name='DCASE 2017::Sound Event Detection in Real-life Audio / Baseline System',
                                              params=params,
                                              system_desc=params.get('description'),
                                              system_parameter_set_id=params.get('active_set'),
